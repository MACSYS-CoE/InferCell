...
\begin{frame}{Level-2 Iterative Boundary: Posterior Tightening}
	\begin{columns}[T]
		\begin{column}{0.55\textwidth}
			\centering
			\includegraphics[width=0.95\textwidth]{example-image-a}\\[3pt]
			{\scriptsize\itshape\color{red!60!black}Placeholder --- real plot to be copied from the cluster integration run (see \texttt{docs/handoff.md}).}
		\end{column}
		\begin{column}{0.42\textwidth}
			\footnotesize
