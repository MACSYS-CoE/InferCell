...
InferCell exports ~30 symbols across seven source files. The pages in this section are organised by source module; each page lists the public API with the same docstring text returned by `?<symbol>` in the Julia REPL.
