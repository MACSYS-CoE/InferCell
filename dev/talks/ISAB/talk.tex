...
%
% ALL THREE corner figures are STALE as of the Aug 2026 palette change and must
% be regenerated together -- the ones on disk still draw the regulator in blue
% and truth in orange. The particle CSVs are not in the repo; they were written
% to examples/results on the cluster (job 15152954) and need fetching or the run
% repeating. Then, from the repo root:
%
